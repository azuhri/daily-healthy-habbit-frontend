...
export default function Feature() {
  return (
    <>
      ...
      <div className="bg-white py-[200px] px-16 md:px-32">
        <p className="text-4xl text-ds-blue-100 text-center font-bold">FITUR</p>
        <div className="flex md:flex-row flex-col my-20 justify-center items-center">
          ...
          >
            <Image
              alt="Icon Monitoring"
              src="/icons/finish-flag2.png"
              width={100}
              height={0}
            />
          </ListFeature2>
        </div>
        <div id="HowToUseSection"></div>
      </div>
    </>
  );
}
