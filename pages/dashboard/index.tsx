    ...
    <LayoutDashboard user={user}>
      <div className="grid grid-cols-2 mt-10">
        <div className="flex col-span-2 mt-2 sm:col-span-1 mr-4 shadow rounded-xl border">
            ...
            <svg viewBox="0 0 24 24" width="100" height="100" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>
            </div>
        ...
        <div className="flex col-span-2 mt-2 sm:col-span-1 ml-4 shadow rounded-xl border">
            ...
            <svg viewBox="0 0 24 24" width="100" height="100" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
            </div>
